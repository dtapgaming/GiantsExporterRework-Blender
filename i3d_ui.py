...
def get_game_install_path_from_prefs():
    ...
    addon_entry = bpy.context.preferences.addons.get("io_export_i3d_10_0_11")
...
class I3D_PT_PanelExport( bpy.types.Panel ):
    ...
    def draw( self, context ):
        ...
        if missing_path:
            ...
            op.module = "io_export_i3d_10_0_11"
# -------------------------------------------
        ...
        if   'exp'  == context.scene.I3D_UIexportSettings.UI_settingsMode:
            ...
            #TODO: add a button that takes user straight to the addon preferences to set the game location add note that the location will now retain between sessions
            # --------------------------
        ...
        if self.state == 0:
            try:
                ...
                try:
                    ...
                    templatesXmlFilename = materialTemplateFilename.replace("$", getGamePath())
