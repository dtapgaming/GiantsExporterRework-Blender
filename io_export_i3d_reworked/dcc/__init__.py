...
def getNodeData(nodeStr):
    ...
    # --------------------------------------------------------------
    # SAFEGUARD: Blender prop collections cannot be indexed with None.
    # Some upstream logic may pass None/"" for a parent placeholder.
    # Treat that as ROOT to avoid a hard crash during export.
    # --------------------------------------------------------------
